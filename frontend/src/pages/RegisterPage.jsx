            ...
            <div className='frame'>
                ...
                <div className='input-group'>
                    ...
                    <div className='input-wrapper'>
                        ...
                        <input className='input-field' name='username' type='username' placeholder='Как к вам обращаться?' />
                    </div>
                ...
                <div className='input-group'>
                    ...
                    <div className='input-wrapper'>
                        ...
                        <input className='input-field' name='email' type='email' placeholder='Введите ваш email' />
                    </div>
                    <div className='input-line'></div>
                </div>
                ...
                <div className='input-group'>
                    ...
                    <div className='password-wrapper'>
                        <div className='input-wrapper'>
                            ...
                            <input className='input-field' name='password' type={showPassword1 ? 'text' : 'password'} placeholder='Введите ваш пароль' />
                        </div>
                ...
                <div className='input-group'>
                    <div className='input-label'>Подтвердите пароль</div>
                    <div className='password-wrapper'>
                        <div className='input-wrapper'>
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M19 11H5C3.89543 11 3 11.8954 3 13V20C3 21.1046 3.89543 22 5 22H19C20.1046 22 21 21.1046 21 20V13C21 11.8954 20.1046 11 19 11Z" stroke="#222222" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                            ...
                            <input className="input-field" name="password" type={showPassword2 ? "text" : "password"} placeholder="Подтвердите ваш пароль" />
                        </div>
