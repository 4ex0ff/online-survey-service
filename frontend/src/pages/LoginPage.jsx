            ...
            <div className="frame">
                ...
                <div className="field-wrapper">
                    ...
                    <div className="input-email">
                        ...
                        <input className="field-input" name="email" type="email" placeholder="Введите ваш email" />
                    </div>
                ...
                {/*  --- Пароль ---   */}
                <div className="field-wrapper">
                    <div className="field-title">Пароль</div>
                    <div className="input-password-wrapper">
                        <div className="input-password">
                            ...
                            <input className="field-input" name="password" type={showPassword ? "text" : "password"} placeholder="Введите ваш пароль" />
                        </div>
